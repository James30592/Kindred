...
class Answerer {
    ...
    // Stores the api info for the last queue question in the current queue.
    updateQueueEnd(apiPage, lastQueueItemId) {
        this.endQueueAPIPage = apiPage;
        this.endQueueId = lastQueueItemId;
    }
}
...
class CurrAnswerers {
    ...
    init() {
        setInterval(() => {this.#clearExpired()}, 10000);
    }
    ...
    async #updateUserCategory(userId, catTypeName, categoryName) {
        ...
        this.#users[userId].answersList = newAnswersList.item;
