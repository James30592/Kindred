...
import * as utils from "../public/sharedJs/utils.mjs";
import { CategoryInfo } from "../public/sharedJs/categoryInfo.mjs";
import { UserSimCompForRecommendations } from "./similarity.mjs";
...
export class RecommendationList extends similarity.KindredList {
  ...
  // // Store categoryQuestionsLists for all recommend for categories.
